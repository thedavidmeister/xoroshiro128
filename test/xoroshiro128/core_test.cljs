...
(deftest ??splitmix64
  []
  (let [next-seed #(.add (x/long %) x/L-0x9E3779B97F4A7C15)
        iterator #(map x/value (iterate x/next (x/splitmix64 (x/long %))))
    ...
    (is
     (.equals
      (x/long "-2152535657050944081")
      (x/value (x/splitmix64 0))))

    (is
     (.equals
      (x/long "7960286522194355700")
    ...
    (is
     (.equals
      (x/long "-7995527694508729151")
      (x/value (x/splitmix64 1))))

    (is
     (.equals
      (x/long "-4689498862643123097")
