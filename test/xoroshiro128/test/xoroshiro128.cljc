...
(deftest ??xoroshiro128-jump
 ...
 (let [x (x/xoroshiro128+
          (xoroshiro128.long-int/long "3610677051444252520")
          (xoroshiro128.long-int/long "-111600565950788475"))
       j1 (x/jump x)
       j2 (x/jump (x/next j1))
       j3 (x/jump (x/next j2))
       j4 (x/jump (x/next j3))
  ...
  (is
   (xoroshiro128.long-int/=
    (xoroshiro128.long-int/long "1380011959502460548")
    (x/value j1)))
  (is
   (xoroshiro128.long-int/=
    (xoroshiro128.long-int/long "-8039967115997247744")
    (x/value j2)))
  (is
   (xoroshiro128.long-int/=
    (xoroshiro128.long-int/long "4226878875002605666")
    (x/value j3)))
  (is
   (xoroshiro128.long-int/=
    (xoroshiro128.long-int/long "-7260350153901218819")
    (x/value j4)))
  (is
   (xoroshiro128.long-int/=
    (xoroshiro128.long-int/long "1922911174585345600")
    (x/value j5))))

 (let [x (x/xoroshiro128+
          (xoroshiro128.long-int/long "990903846483086990")
          (xoroshiro128.long-int/long "-9148032195894284410"))
       j1 (x/jump x)
       j2 (x/jump (x/next j1))
       j3 (x/jump (x/next j2))
       j4 (x/jump (x/next j3))
   ...
   (is
    (xoroshiro128.long-int/=
     (xoroshiro128.long-int/long "-202913253275002842")
     (x/value j1)))
   (is
    (xoroshiro128.long-int/=
     (xoroshiro128.long-int/long "-3343919899937856555")
     (x/value j2)))
   (is
    (xoroshiro128.long-int/=
     (xoroshiro128.long-int/long "7815278568507025494")
     (x/value j3)))
   (is
    (xoroshiro128.long-int/=
     (xoroshiro128.long-int/long "-7622830828298576044")
     (x/value j4)))
   (is
    (xoroshiro128.long-int/=
     (xoroshiro128.long-int/long "2861384012317217776")
     (x/value j5))))

 (let [x (x/xoroshiro128+
          (xoroshiro128.long-int/long "-4009791646934021264")
          (xoroshiro128.long-int/long "2482945807292523774"))
       j1 (x/jump x)
       j2 (x/jump (x/next j1))
       j3 (x/jump (x/next j2))
       j4 (x/jump (x/next j3))
   ...
   (is
    (xoroshiro128.long-int/=
     (xoroshiro128.long-int/long "6862507382354034559")
     (x/value j1)))
   (is
    (xoroshiro128.long-int/=
     (xoroshiro128.long-int/long "7011875142185683248")
     (x/value j2)))
   (is
    (xoroshiro128.long-int/=
     (xoroshiro128.long-int/long "-4496564143832921207")
     (x/value j3)))
   (is
    (xoroshiro128.long-int/=
     (xoroshiro128.long-int/long "1853506959186203582")
     (x/value j4)))
   (is
    (xoroshiro128.long-int/=
     (xoroshiro128.long-int/long "-8638081920607530712")
     (x/value j5))))

 (let [x (x/xoroshiro128+
          (xoroshiro128.long-int/long "8408836858555572576")
          (xoroshiro128.long-int/long "-8576334934951868580"))
       j1 (x/jump x)
       j2 (x/jump (x/next j1))
       j3 (x/jump (x/next j2))
       j4 (x/jump (x/next j3))
   ...
   (is
    (xoroshiro128.long-int/=
     (xoroshiro128.long-int/long "-2331108112525860358")
     (x/value j1)))
   (is
    (xoroshiro128.long-int/=
     (xoroshiro128.long-int/long "-7058988001537110731")
     (x/value j2)))
   (is
    (xoroshiro128.long-int/=
     (xoroshiro128.long-int/long "-6592145494078489880")
     (x/value j3)))
   (is
    (xoroshiro128.long-int/=
     (xoroshiro128.long-int/long "-1634515623999943417")
     (x/value j4)))
   (is
    (xoroshiro128.long-int/=
     (xoroshiro128.long-int/long "3097860178046766537")
     (x/value j5))))

 (let [x (x/xoroshiro128+
          (xoroshiro128.long-int/long "1865665657046312887")
          (xoroshiro128.long-int/long "-2081931776983017860"))
       j1 (x/jump x)
       j2 (x/jump (x/next j1))
       j3 (x/jump (x/next j2))
       j4 (x/jump (x/next j3))
   ...
   (is
    (xoroshiro128.long-int/=
     (xoroshiro128.long-int/long "6193425956360965668")
     (x/value j1)))
   (is
    (xoroshiro128.long-int/=
     (xoroshiro128.long-int/long "-5684898831560071200")
     (x/value j2)))
   (is
    (xoroshiro128.long-int/=
     (xoroshiro128.long-int/long "-2065913535431491189")
     (x/value j3)))
   (is
    (=
     (xoroshiro128.long-int/long "9075337997212788543")
     (x/value j4)))
   (is
    (=
     (xoroshiro128.long-int/long "-5025025827370910366")
     (x/value j5))))
 ...
 (let [x (x/xoroshiro128+ "4716662714674336978" "-4755215357118135582")
   ...
   (is
    (xoroshiro128.long-int/=
     (xoroshiro128.long-int/long "9063123224574765832")
     (x/value j1)))
   (is
    (xoroshiro128.long-int/=
     (xoroshiro128.long-int/long "-8444699141156829399")
     (x/value j2)))
   (is
    (xoroshiro128.long-int/=
     (xoroshiro128.long-int/long "-908412126696469887")
     (x/value j3)))
   (is
    (xoroshiro128.long-int/=
     (xoroshiro128.long-int/long "5890875775521162114")
     (x/value j4)))
   (is
    (xoroshiro128.long-int/=
     (xoroshiro128.long-int/long "-3787313022067243265")
     (x/value j5)))))
