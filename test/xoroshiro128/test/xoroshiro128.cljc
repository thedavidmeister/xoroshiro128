...
(deftest ??xoroshiro128-jump
 ...
 (let [x (x/xoroshiro128+
          (cljc-long.core/long "3610677051444252520")
          (cljc-long.core/long "-111600565950788475"))
       j1 (x/jump x)
       j2 (x/jump (x/next j1))
       j3 (x/jump (x/next j2))
       j4 (x/jump (x/next j3))
 ...
 (let [x (x/xoroshiro128+
          (cljc-long.core/long "990903846483086990")
          (cljc-long.core/long "-9148032195894284410"))
       j1 (x/jump x)
       j2 (x/jump (x/next j1))
       j3 (x/jump (x/next j2))
       j4 (x/jump (x/next j3))
 ...
 (let [x (x/xoroshiro128+
          (cljc-long.core/long "-4009791646934021264")
          (cljc-long.core/long "2482945807292523774"))
       j1 (x/jump x)
       j2 (x/jump (x/next j1))
       j3 (x/jump (x/next j2))
       j4 (x/jump (x/next j3))
 ...
 (let [x (x/xoroshiro128+
          (cljc-long.core/long "8408836858555572576")
          (cljc-long.core/long "-8576334934951868580"))
       j1 (x/jump x)
       j2 (x/jump (x/next j1))
       j3 (x/jump (x/next j2))
       j4 (x/jump (x/next j3))
 ...
 (let [x (x/xoroshiro128+
          (cljc-long.core/long "1865665657046312887")
          (cljc-long.core/long "-2081931776983017860"))
       j1 (x/jump x)
       j2 (x/jump (x/next j1))
       j3 (x/jump (x/next j2))
       j4 (x/jump (x/next j3))
