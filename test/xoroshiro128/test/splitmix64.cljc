...
(deftest ??splitmix64
  []
  (let [next-seed #(cljc-long.core/+
                    (cljc-long.core/long %)
                    xoroshiro128.constants/L-0x9E3779B97F4A7C15)
        iterator #(map x/value (iterate x/next (x/splitmix64 (cljc-long.core/long %))))]
    ; Just outlining a list of known-good values.
    (is
     (cljc-long.core/=
      (cljc-long.core/long "-2152535657050944081")
      (x/value (x/splitmix64 0))))

    (is
     (cljc-long.core/=
      (cljc-long.core/long "7960286522194355700")
    ...
    (is
     (cljc-long.core/=
      (cljc-long.core/long "-7995527694508729151")
      (x/value (x/splitmix64 1))))

    (is
     (cljc-long.core/=
      (cljc-long.core/long "-4689498862643123097")
    ...
    (is
     (cljc-long.core/=
      (cljc-long.core/long "-549842748227632346")
      (x/value (x/splitmix64 "4693323816697189744"))))

    (is
     (cljc-long.core/=
      (cljc-long.core/long "1984452702661322627")
      (x/value (xoroshiro128.core/splitmix64 "5165464252035433577"))))

    (is
     (cljc-long.core/=
      (cljc-long.core/long "8603550955848928026")
      (x/value (xoroshiro128.core/splitmix64 "-3762096910555017800"))))

    (is
     (cljc-long.core/=
      (cljc-long.core/long "2259666501077083692")
