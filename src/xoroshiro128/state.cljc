...
(def ^:private rand-state (volatile! nil))

(defn seed-rand!
 "Takes a long, passes it to splitmix64 to create two new longs, then seeds rand with those new longs."
 ([^long x]
  (vreset! rand-state (xoroshiro128.xoroshiro128/xoroshiro128+ x)))
 ([^long a b]
  (vreset! rand-state (xoroshiro128.xoroshiro128/xoroshiro128+ a b))))
